...
import { budgetAccessDenied } from './budget-access.errors';

@Injectable()
export class BudgetAccessAuthz {
  constructor(
    private readonly authorizationRepository: AuthorizationRepository,
    private readonly policyDecisionPoint: PolicyDecisionPointService,
  ) {}

  async assertBudgetAction(
    ...
    await assertPolicyAndGrantScope(
      ...
      },
      {
        ...
        context: toResourceContextFromPayable(resource),
        onDenied: budgetAccessDenied,
      },
    );
  }
}
