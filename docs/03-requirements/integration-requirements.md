...
| Campo             | Valor                          |
| ----------------- | ------------------------------ |
| Document ID       | Requisitos de integração       |
| Fonte             | SRC-001                        |
...
> | INT-REQ-007 | Pagamento / banco         | Registrar pagamento quando Source of Truth definido                      | FR-039 | PENDING_EXTERNAL_DOCUMENTATION |
> | INT-REQ-008 | Portal do cliente         | Origem de solicitação externa candidata                                  | FR-002 | PENDING_EXTERNAL_DOCUMENTATION |

> Todos `PENDING_EXTERNAL_DOCUMENTATION`. Sem emissão fiscal pelo sistema.
