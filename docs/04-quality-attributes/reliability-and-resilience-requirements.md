...
| REL-REQ-003 | Operações críticas recuperáveis após reinício conforme política | NFR-024 | RISK-011 | PENDING_TARGET_DEFINITION |
| REL-REQ-004 | Reconciliação candidata após falha de integração | NFR-012; FR-030 | RISK-010 | PENDING_SOURCE_VALIDATION |
| REL-REQ-005 | Degradação explícita quando subsistema indisponível | NFR-023, NFR-024 | RISK-002 | PENDING_TARGET_DEFINITION |
