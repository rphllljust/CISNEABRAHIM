...
| TEST-REQ-002 | Cenários de concorrência e idempotência testáveis sem números fixos | QA-SC-001..003 | PENDING_TARGET_DEFINITION |
...
| TEST-REQ-004 | Restore testável em ambiente isolado | QA-SC-022 | PENDING_TARGET_DEFINITION |
