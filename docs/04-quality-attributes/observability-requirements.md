...
| OBS-REQ-005 | METRIC | Métricas de latência e erro por classe de operação | NFR-032 | PENDING_MEASUREMENT |
| OBS-REQ-006 | TRACE | Correlação transversal de operações relacionadas | NFR-030 | PENDING_MEASUREMENT |
| OBS-REQ-007 | ALERT | Alertas para condições críticas candidatas | NFR-031 | PENDING_MEASUREMENT |
| OBS-REQ-008 | HEALTH | Health check para disponibilidade futura | AVAIL-REQ-004 | PENDING_MEASUREMENT |
| OBS-REQ-009 | RUNBOOK | Runbooks para incidentes — escopo futuro (Prompt 32) | — | DRAFT |
| OBS-REQ-010 | CORRELATION | ID de correlação em integrações e operações | NFR-030 | PENDING_MEASUREMENT |
