...
| SEC-REQ-011 | APPLICATION_SECURITY_REQUIREMENT | Sessão com expiração e encerramento | NFR-016 | RISK-007 | PENDING_TARGET_DEFINITION |
| SEC-REQ-012 | APPLICATION_SECURITY_REQUIREMENT | Upload validado quanto a conteúdo malicioso | NFR-017 | RISK-016 | PENDING_TARGET_DEFINITION |
| SEC-REQ-013 | APPLICATION_SECURITY_REQUIREMENT | Segredos não expostos em logs ou UI | NFR-018 | RISK-015 | PENDING_TARGET_DEFINITION |
...
| SEC-REQ-015 | APPLICATION_SECURITY_REQUIREMENT | Limitação de enumeração abusiva | NFR-020 | RISK-007 | PENDING_TARGET_DEFINITION |
...
| SEC-REQ-017 | OPEN_SECURITY_DECISION | Provedor de identidade e fluxo de autenticação | NFR-022 | RISK-007 | PENDING_TARGET_DEFINITION |
| SEC-REQ-018 | OPEN_SECURITY_DECISION | Política de senha / MFA | — | RISK-007 | PENDING_TARGET_DEFINITION |
...
| SEC-REQ-022 | INFRASTRUCTURE_SECURITY_REQUIREMENT | Proteção de dados em repouso — mecanismo a definir | — | RISK-015 | PENDING_TARGET_DEFINITION |
| SEC-REQ-023 | INFRASTRUCTURE_SECURITY_REQUIREMENT | Proteção de dados em trânsito — mecanismo a definir | — | RISK-015 | PENDING_TARGET_DEFINITION |
