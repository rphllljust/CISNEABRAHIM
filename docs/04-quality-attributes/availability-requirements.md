...
## Perguntas para definição futura (NFNQ-012..014)

- Quais operações são críticas 24/7 vs horário comercial?
- Qual tolerância a indisponibilidade planejada?
- Existe requisito de continuidade para integrações externas?
