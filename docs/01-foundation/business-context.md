...
Empresa privada sediada em Porto Velho, Rondônia. Razão social, CNPJ, estrutura societária e organograma: **não fornecidos**.

Patrocinador/owner: **não formalizado**.
...
ERP, rastreamento, fiscal, RH, frotas: **desconhecidos** (`NOT_PROVIDED`).
