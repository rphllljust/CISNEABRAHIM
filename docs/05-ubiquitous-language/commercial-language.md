...
```text
Proposta? → Pedido? → Contrato? → PO? → OS (TERM-002) → Medição → Faturamento informado
```

Cardinalidade: **aberta** (DDP-009). Não desenhar como fluxo obrigatório.

## FRs relacionados

FR-029, FR-030, FR-031, FR-032, FR-033, FR-034, FR-038, FR-039
